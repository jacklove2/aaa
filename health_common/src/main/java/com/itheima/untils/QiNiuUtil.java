...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "A1Paj77aadG7eDj6AJWZ0LX2Wh1c3iFOSGbqxxmv";
    private static final String SECRETKEY = "aAUgddbUjj4xysFvCnQsrH6wyhJretD5LxfN7RoH";
    private static final String BUCKET = "heima74";
    public static final String DOMAIN= "pybrey8j5.bkt.clouddn.com";

    public static void main(String[] args) {
        uploadFile("C:\\Users\\86189\\Desktop\\vue的绑定.png","vue的绑定.png");
